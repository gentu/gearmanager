...
.field private p:Landroid/support/v4/widget/aq;

.field private final q:Landroid/support/v4/widget/bf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/as;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/an;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/bo;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    invoke-static {p0, v2}, Landroid/support/v4/view/bo;->c(Landroid/view/View;I)V

    new-instance v1, Landroid/support/v4/widget/ap;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/ap;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/support/v4/widget/am;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;

    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
...
.method private a(Landroid/view/View;FI)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/bo;->g(Landroid/view/View;)I
    ...
    invoke-static {p1, v5, v0}, Landroid/support/v4/view/bo;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v4/widget/ao;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method static synthetic b(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/support/v4/widget/bf;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
...
.method private static f(Landroid/view/View;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/bo;->j(Landroid/view/View;)Z
...
.method private g(Landroid/view/View;)V
    ...
    sget-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/as;

    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/as;->a(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/aq;
    ...
    invoke-interface {v0, p1, v1}, Landroid/support/v4/widget/aq;->a(Landroid/view/View;F)V
...
.method a(FI)Z
    ...
    :goto_1
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/aq;->a(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/aq;->b(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/bf;->f()V
...
.method protected onDetachedFromWindow()V
    ...
    check-cast v0, Landroid/support/v4/widget/ao;

    invoke-virtual {v0}, Landroid/support/v4/widget/ao;->run()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
    ...
    :goto_2
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bf;->a()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bf;->f()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/bf;

    invoke-virtual {v5}, Landroid/support/v4/widget/bf;->d()I
...
.method public setPanelSlideListener(Landroid/support/v4/widget/aq;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/aq;
