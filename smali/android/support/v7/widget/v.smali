...
.method constructor <init>(Landroid/support/v7/widget/LinearLayoutManager;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/v;->d:Landroid/support/v7/widget/LinearLayoutManager;
...
.method static synthetic a(Landroid/support/v7/widget/v;Landroid/view/View;Landroid/support/v7/widget/bg;)Z
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/v;->a(Landroid/view/View;Landroid/support/v7/widget/bg;)Z
...
.method private a(Landroid/view/View;Landroid/support/v7/widget/bg;)Z
    .locals 2
...
.method a()V
    ...
    iput v0, p0, Landroid/support/v7/widget/v;->a:I
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/v;->c:Z
...
.method public a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/v;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/v;->b(Landroid/view/View;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/v;->d:Landroid/support/v7/widget/LinearLayoutManager;

    invoke-virtual {v1, p1}, Landroid/support/v7/widget/LinearLayoutManager;->d(Landroid/view/View;)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/v;->a:I

    iget-boolean v1, p0, Landroid/support/v7/widget/v;->c:Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/v;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/v;->d:Landroid/support/v7/widget/LinearLayoutManager;
...
.method b()V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/v;->c:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v7/widget/v;->a:I
