...
.field r:Landroid/support/v7/widget/be;
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/support/v7/widget/av;
    .locals 5
    ...
    sget-object v1, Landroid/support/v7/a/b;->RecyclerView:[I

    invoke-virtual {p0, p1, v1, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Landroid/support/v7/a/b;->RecyclerView_android_orientation:I

    invoke-virtual {v1, v2, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, v0, Landroid/support/v7/widget/av;->a:I

    sget v2, Landroid/support/v7/a/b;->RecyclerView_spanCount:I

    invoke-virtual {v1, v2, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, v0, Landroid/support/v7/widget/av;->b:I

    sget v2, Landroid/support/v7/a/b;->RecyclerView_reverseLayout:I
    ...
    sget v2, Landroid/support/v7/a/b;->RecyclerView_stackFromEnd:I
...
.method static synthetic a(Landroid/support/v7/widget/au;Landroid/support/v7/widget/be;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/be;)V

    return-void
.end method

.method private a(Landroid/support/v7/widget/ba;ILandroid/view/View;)V
    .locals 2

    invoke-static {p3}, Landroid/support/v7/widget/RecyclerView;->c(Landroid/view/View;)Landroid/support/v7/widget/bj;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/au;->f(I)V

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ba;->b(Landroid/support/v7/widget/bj;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/au;->g(I)V

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/ba;->c(Landroid/view/View;)V

    iget-object v1, p0, Landroid/support/v7/widget/au;->q:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/bt;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bt;->h(Landroid/support/v7/widget/bj;)V
...
.method private a(Landroid/support/v7/widget/be;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/au;->r:Landroid/support/v7/widget/be;

    if-ne v0, p1, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/widget/au;->r:Landroid/support/v7/widget/be;
...
.method private a(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/bj;->isRemoved()Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bt;->e(Landroid/support/v7/widget/bj;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/bj;->wasReturnedFromScrap()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v1}, Landroid/support/v7/widget/bj;->isScrap()Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/bj;->unScrap()V

    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/au;->p:Landroid/support/v7/widget/d;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/bj;->itemView:Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bt;->f(Landroid/support/v7/widget/bj;)V

    goto :goto_0

    :cond_5
    invoke-virtual {v1}, Landroid/support/v7/widget/bj;->clearReturnedFromScrapFlag()V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/au;->p:Landroid/support/v7/widget/d;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/au;

    invoke-virtual {v3, v2, p2}, Landroid/support/v7/widget/au;->c(II)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/au;->r:Landroid/support/v7/widget/be;
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/be;->b(Landroid/view/View;)V
...
.method public D()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bo;->n(Landroid/view/View;)I
...
.method public E()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bo;->o(Landroid/view/View;)I
...
.method H()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/au;->h(I)Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ak;->getItemCount()I
...
.method a(II)V
    ...
    iput v1, p0, Landroid/support/v7/widget/au;->f:I
...
.method public a(ILandroid/support/v7/widget/ba;)V
    .locals 1

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->h(I)Landroid/view/View;

    move-result-object v0

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->f(I)V

    invoke-virtual {p2, v0}, Landroid/support/v7/widget/ba;->a(Landroid/view/View;)V
...
.method public a(Landroid/graphics/Rect;II)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->y()I

    move-result v1

    add-int/2addr v0, v1

    invoke-virtual {p0}, Landroid/support/v7/widget/au;->A()I
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->z()I
    ...
    invoke-static {p2, v0, v2}, Landroid/support/v7/widget/au;->a(III)I
    ...
    invoke-static {p3, v1, v2}, Landroid/support/v7/widget/au;->a(III)I

    move-result v1

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/au;->d(II)V
...
.method a(Landroid/support/v4/view/a/g;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/support/v4/view/a/g;)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;IILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/au;->c(Landroid/support/v7/widget/RecyclerView;II)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/ba;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->e(Landroid/support/v7/widget/RecyclerView;)V
...
.method public a(Landroid/support/v7/widget/ba;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/au;->h(I)Landroid/view/View;

    move-result-object v1

    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;ILandroid/view/View;)V
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;II)V
    .locals 1
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/support/v4/view/a/g;)V
    .locals 4
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bo;->b(Landroid/view/View;I)Z
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/bo;->b(Landroid/view/View;I)Z
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)I

    move-result v0

    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/au;->b(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)I

    move-result v1

    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/au;->e(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)Z

    move-result v2

    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/au;->d(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)I
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/view/accessibility/AccessibilityEvent;)V
    .locals 4
    ...
    invoke-static {v2, v0}, Landroid/support/v4/view/bo;->b(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bo;->b(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v0}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
...
.method public a(Landroid/view/View;II)V
    ...
    invoke-static {v3, v4, v2, v5, v6}, Landroid/support/v7/widget/au;->a(IIIIZ)I
    ...
    invoke-static {v3, v4, v1, v5, v6}, Landroid/support/v7/widget/au;->a(IIIIZ)I

    move-result v1

    invoke-virtual {p0, p1, v2, v1, v0}, Landroid/support/v7/widget/au;->b(Landroid/view/View;IILandroid/support/v7/widget/RecyclerView$LayoutParams;)Z
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$LayoutParams;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bt;->e(Landroid/support/v7/widget/bj;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bt;->f(Landroid/support/v7/widget/bj;)V
...
.method a(Landroid/view/View;Landroid/support/v4/view/a/g;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/d;->c(Landroid/view/View;)Z
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/view/View;Landroid/support/v4/view/a/g;)V

    :cond_0
    return-void
.end method

.method public a(Landroid/view/View;Landroid/support/v7/widget/ba;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->c(Landroid/view/View;)V

    invoke-virtual {p2, p1}, Landroid/support/v7/widget/ba;->a(Landroid/view/View;)V
...
.method public a(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/view/accessibility/AccessibilityEvent;)V
...
.method a(ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;ILandroid/os/Bundle;)Z
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/bg;Landroid/view/View;Landroid/view/View;)Z
    .locals 1
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/au;->q()Z
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;ILandroid/os/Bundle;)Z
    .locals 6
    ...
    invoke-static {v3, v4}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
    ...
    invoke-static {v3, v2}, Landroid/support/v4/view/bo;->a(Landroid/view/View;I)Z
...
.method public a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/view/View;ILandroid/os/Bundle;)Z
    .locals 1
...
.method a(Landroid/view/View;IILandroid/support/v7/widget/RecyclerView$LayoutParams;)Z
    ...
    invoke-static {v0, p2, v1}, Landroid/support/v7/widget/au;->b(III)Z
    ...
    invoke-static {v0, p3, v1}, Landroid/support/v7/widget/au;->b(III)Z
...
.method a(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView;->b:Landroid/support/v7/widget/ba;

    iget-object v0, p0, Landroid/support/v7/widget/au;->q:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/bg;
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;Landroid/view/View;ILandroid/os/Bundle;)Z
...
.method b(II)V
    ...
    invoke-virtual {p0, v8}, Landroid/support/v7/widget/au;->h(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v10}, Landroid/support/v7/widget/au;->h(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v10}, Landroid/support/v7/widget/au;->j(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v10}, Landroid/support/v7/widget/au;->i(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v10}, Landroid/support/v7/widget/au;->k(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/graphics/Rect;II)V
...
.method b(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/au;->q:Landroid/support/v7/widget/RecyclerView;

    iput-object v2, p0, Landroid/support/v7/widget/au;->p:Landroid/support/v7/widget/d;
...
.method b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/ba;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/ba;)V

    return-void
.end method

.method b(Landroid/support/v7/widget/ba;)V
    .locals 6

    const/4 v5, 0x0

    invoke-virtual {p1}, Landroid/support/v7/widget/ba;->d()I
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ba;->e(I)Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {v3, v5}, Landroid/support/v7/widget/bj;->setIsRecyclable(Z)V

    invoke-virtual {v3}, Landroid/support/v7/widget/bj;->isTmpDetached()Z
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ao;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v7/widget/ao;->c(Landroid/support/v7/widget/bj;)V

    :cond_2
    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/bj;->setIsRecyclable(Z)V

    invoke-virtual {p1, v2}, Landroid/support/v7/widget/ba;->b(Landroid/view/View;)V

    goto :goto_1

    :cond_3
    invoke-virtual {p1}, Landroid/support/v7/widget/ba;->e()V
...
.method public c(I)Landroid/view/View;
    ...
    :cond_1
    invoke-virtual {v3}, Landroid/support/v7/widget/bj;->getLayoutPosition()I
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/bg;->a()Z
...
.method public c(II)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->g(I)V
...
.method public c(Landroid/support/v7/widget/ba;)V
    .locals 2
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/widget/au;->a(ILandroid/support/v7/widget/ba;)V
...
.method public d(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)I
    .locals 1
...
.method public e(Landroid/support/v7/widget/ba;Landroid/support/v7/widget/bg;)Z
    .locals 1
...
.method f(Landroid/support/v7/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/au;->a(II)V
...
.method public j(Landroid/view/View;)I
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/au;->o(Landroid/view/View;)I
...
.method public r()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/bo;->h(Landroid/view/View;)I
